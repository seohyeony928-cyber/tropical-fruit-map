...
FRUIT_INFO = {
    "애플망고": {"optimal_temp": "20~30도", "link": "https://www.nihhs.go.kr/", "desc": "일조량이 풍부해야 당도가 높음"},
    "패션프루트": {"optimal_temp": "20~25도", "link": "https://www.nihhs.go.kr/", "desc": "배수가 잘 되는 토양 필요"},
    "파파야": {"optimal_temp": "25~30도", "link": "https://www.nihhs.go.kr/", "desc": "고온다습한 환경 선호"},
}

# 지역별 과일 적합도 점수 (예시)
SUITABILITY_DATA = {
    "제주 서귀포": {"애플망고": "1등급 (최적)", "패션프루트": "1등급 (최적)", "파파야": "2등급 (적합)"},
    "전남 해남": {"애플망고": "2등급 (적합)", "패션프루트": "1등급 (최적)", "파파야": "3등급 (가능)"},
    "경남 통영": {"애플망고": "2등급 (적합)", "패션프루트": "2등급 (적합)", "파파야": "3등급 (가능)"},
}
...
if mode == "📍 지역별 상세 분석":
    ...
    with col2:
        ...
        if selected_region:
            ...
            # 탭으로 정보를 깔끔하게 구분
            tab1 = st.tabs(["🌱 등급 및 순위", "🌡️ 기후/토양 정보", "💡 종합 의견"])
