...
FRUIT_INFO = {
    ...
    "포도": {"optimal_temp": "20~25도", "watery": "50~60%", "flower": "5~6월", "link": "https://www.nihhs.go.kr/", "desc": "배수가 잘 되고 일교차가 커야 함"},
}

# [수정된 데이터] 현재 기준 적합도 ('포도' 등급 추가됨)
SUITABILITY_DATA = {
    "제주 서귀포": {"망고": "1등급 (최적)", "파파야": "2등급 (적합)", "포도": "3등급 (가능)"},
    "전남 해남": {"망고": "2등급 (적합)", "파파야": "3등급 (가능)", "포도": "2등급 (적합)"},
    "경남 통영": {"망고": "2등급 (적합)", "파파야": "3등급 (가능)", "포도": "1등급 (최적)"},
}

# [수정된 데이터] 난이도 정보 ('포도' 추가됨)
LEVEL_DATA = {
    "망고": {"watery": "상", "temperature": "상", "fruits": "중", "bug": "상", "price": "상"},
    "파파야": {"watery": "중", "temperature": "중", "fruits": "하", "bug": "중", "price": "중"},
    "포도": {"watery": "하", "temperature": "중", "fruits": "중", "bug": "중", "price": "중"},
}
